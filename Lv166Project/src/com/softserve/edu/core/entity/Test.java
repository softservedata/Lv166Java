...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 * type.setTypeName("природній"); Integer id = (Integer)
			 * session.save(type); type.setTypeId(id);
			 * 
			 * ResourceType type2 = new ResourceType();
			 * type2.setTypeName("водний"); id = (Integer) session.save(type2);
			 * type2.setTypeId(id);
			 * 
			 * Role role = new Role(); role.setName(Name.REGISTRATOR);
			 * role.setDescription("реєстратор"); id = (Integer)
			 * session.save(role); role.setRoleId(id);
			 */
			...
			// ResourceClassDAOImpl resourceClassDAOImpl = new
			// ResourceClassDAOImpl();
			...
			// ResourceSubClassDAOImpl resourceSubClassDAOImpl = new
			// ResourceSubClassDAOImpl();
